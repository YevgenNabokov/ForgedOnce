...
namespace Game08.Sdk.CodeMixer.Core.Metadata2.Changes
{
    ...
    {
        public Modified(ISingleNodeScope target, int batchindex, string stageName, string pluginId, object pluginMetadata, IDictionary<string, string> tags)
        ...
        public ISingleNodeScope Target { get; private set; }
    }
}
