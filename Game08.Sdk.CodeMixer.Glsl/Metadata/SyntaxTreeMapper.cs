...
namespace Game08.Sdk.CodeMixer.Glsl.Metadata
{
    public static class SyntaxTreeMapper
    {
        ...
        {
            var cSharpSyntaxNamespace = string.Join(".", nameof(Game08), nameof(Game08.Sdk), nameof(Game08.Sdk.GlslLanguageServices), nameof(Game08.Sdk.GlslLanguageServices.LanguageModels), nameof(Game08.Sdk.GlslLanguageServices.LanguageModels.Ast));
