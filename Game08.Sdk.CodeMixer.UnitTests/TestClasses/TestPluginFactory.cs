...
namespace Game08.Sdk.CodeMixer.UnitTests.TestClasses
{
    ...
    {
        public CodeGenerationPlugin<TestPluginSettings, TestPluginMetadata, CodeFileCSharp> CreatePlugin(JObject configuration, IPluginPreprocessor<TestPluginMetadata> pluginPreprocessor = null)
        {
